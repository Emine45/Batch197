...
public class C03Arrays {
    ...
    public static void main(String[] args) {
        ...
        // When we learn something new follow these step: 1) What   2) Why
        ...
        System.out.println(Arrays.toString(numsArr));  // [8, 12, 34, 10, 78, 19]


        Arrays.sort(numsArr);           // [8, 10, 12, 19, 34, 78]
